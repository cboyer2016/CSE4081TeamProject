...
class list_of_base_exponent_pairs:
    ...
    def determine_numbers(self, a, b, p):
        ...
        for pair in self.bep_list:
            ...
            for x in range(pair.exponent):
                #print('     x_' + str(x) + ' :')
                #print('         b^((p-1)/q) = a^(((p-1)/q)*x_' + str(x) + ')')
                #print('         ' + str(beta) + '^(' + str(p-1) + '/' + str(pair.get_value()) + ') = ' + str(a) + '^(' + str(p-1) + '/' + str(pair.get_value()) + '*x_' + str(x) + ')')
        ...
        print(str(b) + ' = ' + str(a) + '^(' + str(x_final) + ') (mod ' + str(p) + ') : ' + str(b == (a**x_final) % p))
